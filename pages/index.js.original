    ...
    <>
        ...
        <div className="inner" style={{paddingTop:"6rem",paddingBottom:"6rem"}}>
          ...
          <div className="security-grid">
            {[
              ...
              { title: "Architecture Local-First", desc: "Vos messages, votre historique et vos clés cryptographiques sont stockés sur votre appareil, dans une base de données SQLCipher chiffrée. Sans votre code PIN, personne ne peut y accéder.", law: "SQLCipher · Secure Enclave / TEE · AES-256" },
            ].map((s, i) => (
      ...
      <div className="legal-section" id="cgu">
        ...
        {[
          ...
          { title: "Article 5 — Protection des données personnelles", content: (
            ...
            <p>Les données stockées sur les serveurs Hetzner (Allemagne) sont chiffrées et ne peuvent être lues par aucun employé d'Alcorb. Les métadonnées de connexion sont conservées pour une durée maximale de 12 mois, conformément à la loi.</p></>
          )},
      ...
      <div className="legal-section" id="confidentialite">
        ...
        <div className="article">
          ...
          <p>Aucun transfert de données personnelles hors de l'Union européenne. Nos serveurs sont situés en Allemagne (Hetzner, FSN1). Les paiements sont traités en Irlande (Stripe).</p>
        </div>
      </div>
